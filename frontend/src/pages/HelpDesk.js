...
import './HelpDesk.css';
import { ExternalLink, FileText, BarChart3, Megaphone, Activity, Truck, ShieldCheck, Scale, Users, BookOpen } from 'lucide-react';

const HelpDesk = () => {
    const helpDesks = [
        { name: "Mesa de Ayuda Planeación e Información", url: "http://192.168.40.250:8202/index.php?noAUTO=1", icon: BarChart3 },
        { name: "Mesa de Ayuda Comunicación y Mercadeo", url: "http://192.168.40.250:8205/index.php?noAUTO=1", icon: Megaphone },
        { name: "Mesa de Ayuda Ingeniería Biomédica", url: "http://192.168.40.250:8203/index.php?noAUTO=1", icon: Activity },
        { name: "Mesa de Ayuda Apoyo Logístico", url: "http://192.168.40.250:8204/index.php?noAUTO=1", icon: Truck },
        { name: "Mesa de Ayuda Control Interno", url: "http://192.168.40.250:8208/index.php?noAUTO=1", icon: ShieldCheck },
        { name: "Mesa de Ayuda Jurídica", url: "http://192.168.40.250:8207/index.php?noAUTO=1", icon: Scale },
        { name: "Mesa de Ayuda Talento Humano", url: "http://192.168.40.250:8206/index.php?noAUTO=1", icon: Users },
    ];
            ...
            <div className="help-desk-grid">
                {helpDesks.map((desk, index) => (
                    <a key={index} href={desk.url} className="help-desk-item" target="_blank" rel="noopener noreferrer">
                        <desk.icon size={32} className="desk-icon" />
                ...
                <a href={manualUrl} className="help-desk-item manual-item" target="_blank" rel="noopener noreferrer">
                    <BookOpen size={32} className="desk-icon" />
